...
starting_relationships = [
    ...
    ('Hecate', 'First Witch','Professional Bond'),
    ('Ghost of Banquo', 'First Witch','Professional Bond'),
    ('Ghost of Banquo', 'Second Witch','Professional Bond'),
    ('Ghost of Banquo', 'Third Witch','Professional Bond'),
