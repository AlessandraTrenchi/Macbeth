...
param = {
    ...
    'Role': ['Minor Character','Antagonist', 'Antagonist', 'Antagonist', 'Protagonist', 'Confidant', 'Minor Character', 'Henchman', 'Antagonist', 'Minor Character', 'Minor Character', 'Minor Character', 'Confidant', 'Antagonist', 'Minor Character', 'Antagonist', 'Minor Character', 'Henchman', 'Henchman', 'Henchman', 'Antagonist', 'Antagonist', 'Minor Character', 'Minor Character', 'Minor Character', 'Antagonist', 'Antagonist', 'Antagonist', 'Minor Character', 'Minor Character', 'Henchman', 'Antagonist', 'Antagonist', 'Antagonist'],
    'Description': [
