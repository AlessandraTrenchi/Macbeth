...
param = {
    ...
    'Role': ['Foil','Antagonist', 'Antagonist', 'Antagonist', 'Protagonist', 'Confidant', 'Supporting Character', 'Guide', 'Supporting Character', 'Supporting Character', 'Supporting Character', 'Supporting Character', 'Confidant', 'Antagonist', 'Supporting Character', 'Supporting Character', 'Supporting Character', 'Foil', 'Henchman', 'Henchman', 'Antagonist', 'Antagonist', 'Love Interest', 'Supporting Character', 'Foil', 'Antagonist', 'Antagonist', 'Antagonist', 'Supporting Character', 'Supporting Character', 'Henchman', 'Antagonist', 'Antagonist', 'Deuteragonist'],
    'Description': [
