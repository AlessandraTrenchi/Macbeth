...
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'Attendants')
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'Servant')
...
all_scenes_cooccurrences.add_cooccurrence('ATTENDANTS', 'MACBETH')
all_scenes_cooccurrences.add_cooccurrence('SERVANT', 'MACBETH')
...
all_scenes_cooccurrences.add_cooccurrence('CAITHNESS', 'Soldiers')
all_scenes_cooccurrences.add_cooccurrence('ANGUS', 'LENNOX')
all_scenes_cooccurrences.add_cooccurrence('ANGUS', 'ROSS')
all_scenes_cooccurrences.add_cooccurrence('ANGUS', 'Soldiers')
all_scenes_cooccurrences.add_cooccurrence('LENNOX', 'ROSS')
all_scenes_cooccurrences.add_cooccurrence('LENNOX', 'Soldiers')
all_scenes_cooccurrences.add_cooccurrence('ROSS', 'Soldiers')

# Act V, Scene 5
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'SEYTON')
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'Soldiers')
all_scenes_cooccurrences.add_cooccurrence('SEYTON', 'Soldiers')
all_scenes_cooccurrences.add_cooccurrence('DOCTOR', 'MACBETH')
all_scenes_cooccurrences.add_cooccurrence('DOCTOR', 'SEYTON')
all_scenes_cooccurrences.add_cooccurrence('ATTENDANTS', 'MACBETH')
all_scenes_cooccurrences.add_cooccurrence('SERVANT', 'MACBETH')
all_scenes_cooccurrences.add_cooccurrence('SEYTON', 'MACBETH')
all_scenes_cooccurrences.add_cooccurrence('MESSENGER', 'MACBETH')
# Act V, Scene 6
all_scenes_cooccurrences.add_cooccurrence('MALCOLM', 'SIWARD')
all_scenes_cooccurrences.add_cooccurrence('MALCOLM', 'MACDUFF')
...
all_scenes_cooccurrences.add_cooccurrence('YOUNG SIWARD', 'They fight')
all_scenes_cooccurrences.add_cooccurrence('MACDUFF', 'MACBETH')
# Act V, Scene 8
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'MACDUFF')
all_scenes_cooccurrences.add_cooccurrence('MACBETH', 'fighting')
all_scenes_cooccurrences.add_cooccurrence('MACDUFF', 'fighting')
all_scenes_cooccurrences.add_cooccurrence('MALCOLM', 'SIWARD')
all_scenes_cooccurrences.add_cooccurrence('MALCOLM', 'ROSS')
all_scenes_cooccurrences.add_cooccurrence('SIWARD', 'ROSS')
all_scenes_cooccurrences.add_cooccurrence('MALCOLM', 'MACDUFF')
